...
Route::get('wellsample/csw-1d/chart', 'WellSampleController@csw1dChart');
Route::get('wellsample/csw-1s/chart', 'WellSampleController@csw1sChart');
Route::get('wellsample/csw-2r/chart', 'WellSampleController@csw2rChart');
Route::get('wellsample/hmw-3/chart', 'WellSampleController@hmw3Chart');
Route::get('wellsample/hmw-8r/chart', 'WellSampleController@hmw8rChart');
Route::get('wellsample/hmw-14/chart', 'WellSampleController@hmw14Chart');
Route::get('wellsample/hmw-15/chart', 'WellSampleController@hmw15Chart');
Route::get('wellsample/smw-a/chart', 'WellSampleController@smwaChart');
Route::get('wellsample/smw-1/chart', 'WellSampleController@smw1Chart');
Route::get('wellsample/smw-13/chart', 'WellSampleController@smw13Chart');
Route::get('wellsample/psw-1/chart', 'WellSampleController@psw1Chart');
Route::get('wellsample/psw-2/chart', 'WellSampleController@psw2Chart');
...
Route::get('wellsample/62fts/chart', 'WellSampleController@fts62Chart');
Route::get('wellsample/82fts/chart', 'WellSampleController@fts82Chart');
